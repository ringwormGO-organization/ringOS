...
uint8_t cursor2[]
{
    0b1000000001,0b1000000000,
    0b1000000011,0b1100000000,
    0b1000000111,0b1110000000,
    0b1000001111,0b1111000000,
    0b1000011111,0b1111100000,
    0b1000111111,0b1111111000,
    0b1011111111,0b1001111110,
    0b1000000000,0b1000000000,
    0b0000000111,0b1110000000,
    0b0000000111,0b1110000000,
    0b0000000111,0b1110000000,
    0b0000000111,0b1110000000,
    0b0000000111,0b1110000000,
...
namespace GUI
{
    void Draw()
    {
        ...
        if (MousePacket[0] & PS2Leftbutton)
        {
            ...
            else if (MousePosition.Y >= close.ybuttonclose 
            && MousePosition.Y <= close.ybuttonclose + 20 && MousePosition.X >= close.xbuttonclose 
            && MousePosition.X <= close.xbuttonclose + 20)
            {
